	...
	<div class="col-md-12">
		...
		<div class="form-group">
			...
			//dana cadangan 
				...
				echo form_label('Kontribusi ke Lembaga (%)', 'dana_cadangan');
				...
				echo form_label('Pengembangan Usaha BMT (%)', 'jasa_usaha');
				echo form_input($data);
				echo '
				</td>
			</tr>';				
			...
			echo form_label('Kontribusi ke Jurusan (%)', 'dana_pengurus');
			echo form_input($data);
			echo '
				</td>
				<td>';
