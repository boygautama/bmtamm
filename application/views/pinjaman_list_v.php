					...
					<table>
						...
						<tr style="height:35px">
							...
							<td>
								...
								<input type="text" id="bunga_txt" name="bunga_txt" style="" />
							</td>	
						</tr>
						<tr style="height:35px">
							<td>Biaya Admin</td>
							...
							<td>
								...
								<input type="text" id="biaya_adm_txt" name="biaya_adm_txt" />
							</td>	
						</tr>
						<tr style="height:35px">
...
function create(){
	...
	var val_bunga = $(this).val();
	$('#bunga_txt').val(number_format(val_bunga));
	});
